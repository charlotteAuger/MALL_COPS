...
Shader "S_Dithering"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 lerpResult89 = lerp( _Color0 , _Color1 , saturate( step( tex2D( _Texture0, ( (( ase_screenPosNorm * _ScreenParams * _Texture0_TexelSize )).xy * _Tiling ) ).r , dotResult17 ) ));
...
/*ASEBEGIN
Version=16400
122;100;1682;919;2702.031;838.8221;1.978581;True;False
...
Node;AmplifyShaderEditor.StepOpNode;18;-963.6174,-107.3053;Float;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;92;-740.5642,-84.4641;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=BFD2DA161A4F5D16FE4E225012BBCEB4CBB03293