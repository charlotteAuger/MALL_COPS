...
Shader "S_Gage"
{
	Properties
	{
		...
		_AngeryValue("AngeryValue", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		uniform float _AngeryValue;
		uniform sampler2D _T_Angry;
		uniform float _Cutoff = 0.5;

		void surf( Input i , inout SurfaceOutputStandard o )
		{
			float4 lerpResult24 = lerp( _GageColor01 , _GageColor02 , _AngeryValue);
			...
			clip( ( ( ( 1.0 - ceil( ( _AngeryValue - (0.0 + (atan2( break9.y , break9.x ) - -3.5) * (1.0 - 0.0) / (3.5 - -3.5)) ) ) ) * ( floor( ( temp_output_4_0 + 0.3 ) ) * ( 1.0 - floor( temp_output_4_0 ) ) ) ) + tex2D( _T_Angry, ( i.uv_texcoord * ( appendResult35 + float2( 1,1 ) ) ) ).a ) - _Cutoff );
		}
...
/*ASEBEGIN
Version=16400
1921;1;1598;837;1483.301;146.7064;1.3;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;14;-1509.352,-124.3879;Float;False;Property;_AngeryValue;AngeryValue;1;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=E67962D60BCB46ACBC77AFB2C567FFCC0B9717B1